            ...
            <div class="col-lg-8 col-xl-9">
                ...
                <div>
                    ...
                    <article class="pt-2">
                        ...
                        <h3 class="pb-2">What we can do?</h3>
                        <p>Lorem ipsum dolor sit
                            amet, consectetur adipisicing elit,
                            sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Ut
                            enim ad minim veniam</p>
                        <div class="accordion bg-white" id="accordionExample_01">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading_01_1"><button class="py-4 accordion-button fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_01_1" aria-expanded="true" aria-controls="collapse_01_1">Can
                                        I change plans later
                                        on?</button>
                                </h2>
                                <div id="collapse_01_1" class="accordion-collapse collapse" aria-labelledby="heading_01_1" data-bs-parent="#accordionExample_01">
                                    <div class="accordion-body"><strong>This
                                            is the first item's
                                            accordion
                                            body.</strong> It is
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading_01_5"><button class="py-4 accordion-button fw-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_01_5" aria-expanded="false" aria-controls="collapse_01_5">How
                                        do I schedule an
                                        appointment?</button></h2>
